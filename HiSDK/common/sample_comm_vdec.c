...
HI_VOID	SAMPLE_COMM_VDEC_ChnAttr(HI_S32 s32ChnNum, VDEC_CHN_ATTR_S *pstVdecChnAttr, PAYLOAD_TYPE_E enType, SIZE_S *pstSize)
{
    ...
    pstVdecChnAttr->u32BufSize   = 2 * pstSize->u32Width * pstSize->u32Height;
    pstVdecChnAttr->u32Priority  = 1;
...
HI_VOID	SAMPLE_COMM_VDEC_VoAttr(HI_S32 s32ChnNum, VO_DEV VoDev ,VO_PUB_ATTR_S *pstVoPubAttr, VO_VIDEO_LAYER_ATTR_S *pstVoLayerAttr)
{
    ...
    pstVoPubAttr->u32BgColor = VO_BKGRD_BLACK;// 设置背景色为黑色
...
HI_S32 SAMPLE_COMM_VDEC_Start(HI_S32 s32ChnNum, VDEC_CHN_ATTR_S *pstAttr)
{
	...
	{
		CHECK_CHN_RET(HI_MPI_VDEC_SetChnVBCnt(s32ChnNum, u32BlkCnt),s32ChnNum, "HI_MPI_VDEC_SetChnVBCnt");
	}		
    CHECK_CHN_RET(HI_MPI_VDEC_CreateChn(s32ChnNum, pstAttr), s32ChnNum, "HI_MPI_VDEC_CreateChn");
	CHECK_CHN_RET(HI_MPI_VDEC_StartRecvStream(s32ChnNum), s32ChnNum, "HI_MPI_VDEC_StartRecvStream");
